...
STATE_FRAILTY_DEFINITIONS: List[FrailtyDefinition] = [
    ...
    FrailtyDefinition(
        ...
        source_document="NC Medicaid expansion (standard ACA, Dec 2023); NC HealthConnex HIE mandate (N.C.G.S. § 90-414.4)",
        effective_date="2023-12-01",
        notes=(
            "NC is a comparator state (no CER waiver). NC HealthConnex is a state-mandated "
            "HIE with near-universal provider participation, enabling near-real-time event "
            "detection. Included to represent states with strong data infrastructure but no "
            "community engagement requirements. Frailty parameters are estimated based on NC "
            "Medicaid infrastructure characteristics."
        ),
    ),
