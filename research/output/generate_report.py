"""
Health Affairs Research Report Generator
==========================================
Generates a complete research report suitable for submission to Health Affairs
on algorithmic bias in Medicaid medically frail exemption systems under OBBBA.

This module:
1. Runs all analytical components
2. Generates all tables and figures
3. Produces a structured research report in Markdown (and plain text for appendix)

Output: research/output/health_affairs_report.md
        research/output/tables/
        research/output/figures/

Manuscript target: Health Affairs
Section: Policy Briefs / Original Research
Word count target: ~3,000 words (manuscript) + supplementary methods

Suggested citation format (pre-submission):
"Algorithmic Integrity and the Medically Frail Exemption: Evaluating Racial Bias
in Post-OBBBA Medicaid Work Requirement Exemption Systems"
Health Affairs [year]
"""
...
def generate_manuscript(results: dict, disparity_df: pd.DataFrame,
    ...
    """
    Generate the full Health Affairs manuscript in Markdown format.
    """
...
def main():
    ...
    print("\n" + "=" * 70)
    print("HEALTH AFFAIRS RESEARCH REPORT GENERATOR")
    print("Algorithmic Integrity and the Medically Frail Exemption")
    print("=" * 70 + "\n")
    ...
    # Save manuscript
    report_path = OUTPUT_DIR / "health_affairs_report.md"
