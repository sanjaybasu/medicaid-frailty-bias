...
| NPPES NPI-to-state lookup | npiregistry.cms.hhs.gov | downloaded by `data/stream_t1019.py` |
...
│   ├── billing_providers.parquet        # NPPES NPI-to-state (downloaded at runtime, .gitignored)
